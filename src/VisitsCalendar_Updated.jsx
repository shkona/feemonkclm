...
export default function VisitsCalendar({currentUser}){
  ...
  const [selectedVisitForFollowUp,setSelectedVisitForFollowUp]=useState(null);
              ...
              {getVisitsForDate(new Date(selectedDate)).map(visit=>(
                <div key={visit.id} style={{background:"#f8fafc",border:"1px solid #e2e8f0",borderRadius:8,padding:16}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:16}}>
                    ...
                    <div>
                      <button 
                        onClick={()=>setSelectedVisitForFollowUp(visit)}
                        style={{background:"#7c3aed",color:"#fff",border:"none",borderRadius:6,padding:"6px 12px",fontSize:11,fontWeight:600,cursor:"pointer",fontFamily:"inherit"}}
